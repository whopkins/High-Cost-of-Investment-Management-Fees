...
<html>
    ...
    <div id="container">
      ...
      <div class="panel">
        ...
        <p>To see the grim reality firsthand, below is a calculator for measuring the effects of overhead fees on investments.  Input the principal amount invested, the expected returns, the duration of the investment, and the expense ratio.  The calculator will output two amounts: (1) the end of period balance without any overhead and (2) the end of period balance after the management fees.  For example, you might try a repeating $5,000 principal, .05 IRR (5.00%), .005 expense ratio (0.50%), and a 40-year duration.  To compare the calculator results to a spreadsheet that does the calculations, here is a <a href="https://docs.google.com/spreadsheet/ccc?key=0AlTbo6YbaY9AdGp2ajY4NUJveVlvT3Q5WDNBQTZVOWc" target="_blank">link</a>.</p>
      </div>
      <div class="panel">
